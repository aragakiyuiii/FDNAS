...
class CifarDataProvider(DataProvider):
    ...
    def __init__(self, client_id=10, dataset_location=None, train_batch_size=1024,
        ...
        if self.client_id < 10:
            trn_set_list, val_set_list, test_set_list = self.get_image_idx(client=self.client_id)
            self.trn_set = torch.utils.data.Subset(self.train_dataset, indices=trn_set_list)
            self.val_set = torch.utils.data.Subset(self.train_dataset, indices=val_set_list)
            self.test_dataset = torch.utils.data.Subset(self.test_dataset, indices=test_set_list)
        else:
            self.trn_set = torch.utils.data.Subset(self.train_dataset, indices=range(45000))
            self.val_set = torch.utils.data.Subset(self.train_dataset, indices=range(45000, 50000))
    ...
    def valid(self):
        return DataLoaderX(self.val_set,  # DatasetSplit(self.train_dataset, self.val_idxs),
                           batch_size=self.test_batch_size,
                           shuffle=True,  # sampler=self.val_sampler,
                           num_workers=self.n_worker,
                           pin_memory=True,
                           drop_last=False,
                           )
    ...
    def get_image_idx(self, client=10):
        ...
        if client < 3:
            ...
            # sort labels for val
            val_idxs_labels = np.vstack((val_idxs, val_labels))
            val_idxs_labels = val_idxs_labels[:, val_idxs_labels[1, :] < 3]
            val_idxs = val_idxs_labels[0, :]
            ...
            # sort labels for val
            val_idxs_labels = np.vstack((val_idxs, val_labels))
            val_idxs_labels = val_idxs_labels[:, val_idxs_labels[1, :] > 5]
            val_idxs = val_idxs_labels[0, :]
            ...
            # sort labels for val
            val_idxs_labels = np.vstack((val_idxs, val_labels))
            val_idxs_labels = val_idxs_labels[:, val_idxs_labels[1, :] < 6]
            val_idxs_labels = val_idxs_labels[:, val_idxs_labels[1, :] > 2]
            val_idxs = val_idxs_labels[0, :]
        ...
        return trn_idxs.tolist(), val_idxs.tolist(), test_idxs.tolist()
...
class CifarDataProvider100(DataProvider):
    ...
    def get_image_idx(self, client=10):
        ...
        if client < 3:
            ...
            # sort labels for val
            val_idxs_labels = np.vstack((val_idxs, val_labels))
            val_idxs_labels = val_idxs_labels[:, val_idxs_labels[1, :] < 33]
            val_idxs = val_idxs_labels[0, :]
            ...
            # sort labels for val
            val_idxs_labels = np.vstack((val_idxs, val_labels))
            val_idxs_labels = val_idxs_labels[:, val_idxs_labels[1, :] > 66]
            val_idxs = val_idxs_labels[0, :]
            ...
            # sort labels for val
            val_idxs_labels = np.vstack((val_idxs, val_labels))
            val_idxs_labels = val_idxs_labels[:, val_idxs_labels[1, :] < 67]
            val_idxs_labels = val_idxs_labels[:, val_idxs_labels[1, :] > 32]
            val_idxs = val_idxs_labels[0, :]
