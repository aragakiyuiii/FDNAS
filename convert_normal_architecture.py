...
parser.add_argument('--n_epochs', type=int, default=800, help="set circle cosine lr_schedule_type")
...
parser.add_argument('--width_stages', type=str, default='24,40,80,96,192,320',
                    help="width (output channels) of each cell stage in the block")
parser.add_argument('--n_cell_stages', type=str, default='2,3,4,3,4,3',
                    help="number of cells in each cell stage")  # 3,2,4,3,4,3
...
args.save_env = 'env_dir/get_normal_arch-{}-{}-{}'.format(args.arch_algo, args.train_batch_size,
...
if __name__ == '__main__':
    ...
    # get_normal_net
    arch_search_run_manager.get_normal_net()
    print('Already get normal net')
