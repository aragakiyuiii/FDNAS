...
class MixedEdge(MyModule):
    ...
    def probs_over_ops(self):
        probs = F.softmax(self.AP_path_alpha, dim=0)  # softmax to probability for arch_alpha_params
        return probs
    ...
    def binarize(self):
        ...
        if MixedEdge.MODE == 'two':
            ...
            ]), dim=0)  # softmax to probability for arch_alpha_params_SampleByTorchMultinomial
